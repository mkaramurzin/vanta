...
export const metadata: Metadata = {
  title: 'Contact Us - Get Your Free Tile Installation Estimate | Tima Tiles',
  description: 'Contact Tima Tiles for your free consultation and estimate. Licensed tile professionals serving the region. Call (555) 123-4567 or fill out our contact form.',
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <span className="text-blue-100">or fill out the form below</span>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-6 mb-10">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600 mt-1">
                      <a href="tel:(555)123-4567" className="hover:text-blue-600 transition-colors">(555) 123-4567</a>
                    </p>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600 mt-1">
                      <a href="mailto:info@timatiles.com" className="hover:text-blue-600 transition-colors">info@timatiles.com</a>
                    </p>
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-4">Why Choose Tima Tiles?</h3>
