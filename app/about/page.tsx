...
export const metadata: Metadata = {
  title: `About Us - ${brand.companyName} | Professional Tile Contractors`,
  description: `Learn about ${brand.companyName} - over ${brand.business.experience} in professional tile installation, repair, and flooring services. ${brand.tagline}.`,
}
      ...
      <section className="bg-gradient-to-r from-sky-500 to-sky-700 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">About {brand.companyName}</h1>
            <p className="text-xl md:text-2xl text-sky-100 max-w-3xl mx-auto">
              Building trust through exceptional craftsmanship for over {brand.business.experience.replace('+ Years', '+ years')}
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="prose prose-lg text-gray-600">
                <p className="mb-6">
                  Founded in {brand.business.foundedYear}, {brand.companyName} began as a small family business with a simple mission: 
                  to provide homeowners with exceptional tile installation and flooring services that stand the test of time.
                </p>
                <p className="mb-6">
                ...
                <p>
                  Today, we're proud to have completed over {brand.business.projectsCompleted.replace('+', '')} successful projects {brand.business.serviceArea}, 
            ...
            <div className="bg-gray-100 rounded-lg p-8">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="text-center">
                  <div className="text-3xl font-bold text-sky-500 mb-2">{brand.business.projectsCompleted}</div>
                  <div className="text-gray-600">Projects Completed</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-sky-500 mb-2">{brand.business.experience.replace(' Years Experience', '+')}</div>
                  <div className="text-gray-600">Years Experience</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-sky-500 mb-2">{brand.business.rating}</div>
            ...
            <div className="bg-gray-100 rounded-lg p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  <svg className="w-6 h-6 text-sky-500 mr-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  <div>
                    <div className="font-medium text-gray-900">{brand.phone}</div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-medium text-gray-900">{brand.email}</div>
                    <div className="text-sm text-gray-600">We respond within 2 hours</div>
                  </div>
                </div>
                
                <div className="flex items-start">
                  <svg className="w-6 h-6 text-sky-500 mr-4 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                  </svg>
                  <div>
                    <div className="font-medium text-gray-900">{brand.address.street}</div>
                    <div className="text-gray-600">{brand.address.city}, {brand.address.state} {brand.address.zip}</div>
